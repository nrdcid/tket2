...
@s_Postselect.13DF1CD0.0 = private constant [21 x i8] c"\14Postselection failed"
...
id_bb.i.i:                                        ; preds = %reset_bb.i.i, %entry
  ...
  br i1 %.fca.0.extract.i.i, label %__hugr__.__tk2_qalloc.39.exit.i, label %cond_43_case_0.i.i

cond_43_case_0.i.i:                               ; preds = %id_bb.i.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.39.exit.i:                  ; preds = %id_bb.i.i
...
3:                                                ; preds = %__hugr__.__tk2_qalloc.39.exit.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @s_Postselect.13DF1CD0.0, i64 0, i64 0))
  unreachable

__hugr__.main.1.exit:                             ; preds = %__hugr__.__tk2_qalloc.39.exit.i
  %read_bool66.i = tail call i1 @___read_future_bool(i64 %lazy_measure.i)
  tail call void @___dec_future_refcount(i64 %lazy_measure.i)
  tail call void @print_bool(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @res_c.1C9EF4D1.0, i64 0, i64 0), i64 11, i1 %read_bool66.i)
